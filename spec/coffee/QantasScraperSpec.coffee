...
htmlElementWithMobileNumber = (number) ->
  a = '<div class="panel" id="ContactDetails">
  <table cellspacing="0" class="pax-details">
    ...
    <tbody>
      ...
      <tr class="first_pax">
        <td>Ms Minna Yao</td>
        <td>
        <a id="idAqireFFNumber"
        href="javascript:theBKGDForm.submit("UPDATE", "passengerDetails");">
        Add</a>or
        <a target="_blank"
        href="https://www.qantas.com.au/fflyer/dyns/joinff">Join
        now</a></td>
        <td></td>
      </tr>
    </tbody>
  ...
  <table cellspacing="0" class="pax-contact">
    <tbody>
      ...
      <tr>
        ...
        <td>
          <span id="idToCut">oztravel@thoughtworks.com</span>
        </td>
      </tr>
      <tr>
        <td>ABN:</td>
        <td>
          <span>99088279761</span>
        </td>
      </tr>
    </tbody>
  </table>
