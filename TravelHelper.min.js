var service;function initialize(){service=new google.maps.DistanceMatrixService();alert("Service: "+service)}var script=document.createElement("script");script.type="text/javascript";script.src="http://maps.googleapis.com/maps/api/js?sensor=false&callback=initialize";document.body.appendChild(script);
/*!
