...
window.TravelHelper = class TravelHelper
  ...
  run: () ->
    ...
    if readyScraper?
      ...
      UtilScraper.get().getGoogleSpreadsheetAsJson 'pgZYLtdPRv50AK70fqJkQSw', 'od6', (result) -> UtilScraper.get().hotelGoogleSpreadsheetAjaxCallback(result, readyScraper.hostingCity())
